/**
Build suite test
alias build="cxxtestgen --error-printer -o tests/Chapter1Test.cpp tests/Chapter1Test.h && g++ -ggdb -o tests/builds/chapter1 tests/Chapter1Test.cpp"
build
*/
...
How to debug
gdb --args Chapter1Test testCompressString tests/builds/chapter1
break chapter1Tasks.hpp:169
run
*/
...
const char* compressString(const char* string) {
    if (strlen(string) == 0)
        return string;
